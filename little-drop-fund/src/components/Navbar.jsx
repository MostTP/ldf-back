...
// Ensure onOpenSignup is received as a prop
...
<div className="flex items-center text-xl font-bold text-[--dark]">
    {/* 🛑 FIX: Used the simple variable name 'logo' */}
    <img src={logo} alt="LDF Logo" className="h-8 md:h-10 w-auto" /> 
    <span className="ml-2">LITTLE DROP FUND</span> 
</div>
...
className="hover:text-[--dark] transition-fast" 
>
{link.name}
</button>
))}
