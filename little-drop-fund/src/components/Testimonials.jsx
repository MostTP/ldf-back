      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {quotes.map((q, index) => (
            <div
              key={index}
              className="bg-white border border-gray-100 p-8 rounded-xl shadow-soft hover:shadow-lg transition-fast text-left"
            >
              <Quote size={24} className="text-[--emerald] mb-3" />
