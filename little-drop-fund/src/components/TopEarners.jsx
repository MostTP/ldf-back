...
export default function TopEarners() {
  ...
  return (
    <section
      id="topEarners"
      ref={ref}
      className="animate-section py-20 px-6 bg-gray-100"
    >
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-gray-600 mb-10 max-w-2xl mx-auto">
          See the results of active participation and community growth. These
          figures represent total commissions and pool payouts in the last 30
          days.
        </p>
        ...
        <SectionCard className="p-8 mx-auto h-full" borderEmphasis="top">
          <div className="flex items-center justify-center mb-8">
            ...
            <h3 className="text-3xl font-bold text-[--dark] ml-3">
              Leaderboard
            </h3>
          </div>
 ...
 `}
              >
                ...
                <p className="text-2xl font-extrabold text-[--emerald] mt-2">
                  {e.amount}
                </p>
              </div>
            ))}
          ...
          <button onClick={() => navigate("/leaderboard")} className="mt-8 px-8 py-3 rounded-lg bg-[--emerald] hover:bg-green-700 text-white font-semibold shadow-lg shadow-green-500/30 transition-fast">
