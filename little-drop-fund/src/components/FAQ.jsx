...
export default function FAQ() {
  ...
  const faq = [
    ...
    },
    {
      ...
      answer:
        "You activate your account with a one-time ₦5,000 coupon(plus cuopon agent fee between ₦200 to ₦500 maybe attracted). This is the only cost, and monthly subscription of #2,000 which grant you access to the product and earning systrem."
    },
    {
